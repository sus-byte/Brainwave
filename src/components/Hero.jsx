  ...
  return (
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-16 ">
          <h1 className="h1 mb-6">
            Explore the Possibilities of&nbsp;AI&nbsp;Chattting with{" "}
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
            ...
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-b-[0.8rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <ul className="absolute -left-[5.5rem] bottom-[7.5rem] bg-n-9/40 border border-n-1/10 rounded-2xl backdrop-blur p-1 hidden xl:flex">
          ...
          <BackgroundCircles parallaxRef={parallaxRef} />
              ...
              <CompanyLogo className="hidden lg:block relative mt-20 z-10" />
      </div>
